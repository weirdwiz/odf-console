...
- **Naming:** Components: PascalCase. Variables/functions: camelCase. Constants: UPPER_CASE. Types: PascalCase. Directories: kebab-case. Unused variables: prefix with `_`
